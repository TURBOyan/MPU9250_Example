...
//函数兼容
#define OLED_ClearScreen(x)      oled_fill(x)
#define OLED_P6x8Str(x, y, z)    oled_p6x8str(x,y,(uint8*)z)
#define OLED_P6x8Int(x, y, z, a) oled_int16(x, y, z)
#define OLED_P6x8Flo(x, y, z, a) oled_printf_float(x,y,z,(a>0?a:-a),2)
